    ...
    <div class="md-header">
        <div class="md-topbar">
            ...
            <div class="md-top-actions">
                <a href="#" class="md-icon-btn" style="width: auto; padding: 0 14px; border-radius: 12px; font-weight: 800; font-size: 13px; letter-spacing: 0.5px;">EN</a>
                <a href="#" class="md-icon-btn" style="width: auto; padding: 0 14px; border-radius: 12px; font-weight: 700; font-size: 15px;">عربي</a>
            </div>
        </div>
